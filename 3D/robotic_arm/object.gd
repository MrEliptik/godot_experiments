...
func pick_up(by):
	...
	# Turn off visibility for robot camera
	$MeshInstance.set_layer_mask_bit(0, false)
	$MeshInstance.set_layer_mask_bit(9, true)
...
func let_go(impulse = Vector3(0.0, 0.0, 0.0)):
	if picked_up_by:
		...
		# Turn on visibility for robot camera
#		$MeshInstance.set_layer_mask_bit(0, true)
#		$MeshInstance.set_layer_mask_bit(9, false)
